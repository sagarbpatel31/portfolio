...
const COMMANDS: Record<string, () => OutputLine[]> = {
  ...
  neofetch: () => [
    { text: "  SSSSS    A   GGGGG    A   RRRR ", type: "accent" },
    { text: "  S      A   A  G      A   A R   R", type: "accent" },
    { text: "  SSSS   AAAAA  G  GG  AAAAA RRRR ", type: "accent" },
    { text: "      S  A   A  G   G  A   A R R  ", type: "accent" },
    { text: "  SSSSS  A   A  GGGGG  A   A R  R ", type: "accent" },
    { text: "", type: "output" },
