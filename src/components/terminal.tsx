...
const COMMANDS: Record<string, () => OutputLine[]> = {
  ...
  neofetch: () => [
    { text: "  ____    _    ____    _    ____  ", type: "accent" },
    { text: " / ___|  / \\  / ___|  / \\  |  _ \\ ", type: "accent" },
    { text: " \\___ \\ / _ \\| |  _  / _ \\ | |_) |", type: "accent" },
    { text: "  ___) / ___ \\ |_| |/ ___ \\|  _ < ", type: "accent" },
    { text: " |____/_/   \\_\\____/_/   \\_\\_| \\_\\", type: "accent" },
    { text: "", type: "output" },
